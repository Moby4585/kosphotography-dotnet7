            ...
            if (player != null)
            {
                ...
                if (api is ICoreClientAPI capi)
                {
                    ...
                    if ((player.InventoryManager.GetHotbarInventory()[10].Itemstack?.Collectible.Code.ToString() ?? "") == "kosphotography:photographicpaper")
                    {
                        ...
                        //SKBitmap bmp = screenshot.GrabScreenshot(new Size2i((int)Math.Pow(2, KosPhotographyConfig.Current.PhotographLod), (int)Math.Pow(2, KosPhotographyConfig.Current.PhotographLod)), true, false, false);
